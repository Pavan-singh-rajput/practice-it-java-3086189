...
public class MenuBuilder {
  public static void main(String[] args) {
    ...
    // Create a variable called starter of type MenuItem and pass in the name of your favourite starter.
    MenuItem starter = new MenuItem("fry");
    ...
    MenuItem dessert = new MenuItem("Ice");
